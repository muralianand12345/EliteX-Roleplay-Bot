import { EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ModalBuilder, TextInputBuilder, TextInputStyle, Interaction, Client, TextChannel, ModalSubmitInteraction, Message, ButtonInteraction } from "discord.js";
...
const closeTicketEditInt = async (client: Client, interaction: ButtonInteraction) => {
    await interaction.message.edit({ components: [rowDisAll] });
}

const deleteTicketEmbedandClient = async (client: Client, interaction: Interaction, ticketUser: ITicketUser, ticketGuild: ITicketGuild, serverAdd: string, chan: TextChannel, TicketReason: string | null) => {
    const embed = new EmbedBuilder()
...
const deleteTicketSpam = async (client: Client, interaction: ButtonInteraction) => {
...
const reopenEmbedEdit = async (interaction: ButtonInteraction, message: Message) => {
