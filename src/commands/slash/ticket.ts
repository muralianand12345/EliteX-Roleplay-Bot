import { SlashCommandBuilder, Channel, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ChannelType, PermissionFlagsBits, TextChannel, Message } from 'discord.js';

import ticketGuildModal from '../../events/database/schema/ticketGuild';
import { SlashCommand } from '../../types';

const checkChan = (chan: Channel, type: ChannelType) => {
...
const command: SlashCommand = {
    ...
    async execute(interaction, client) {
        ...
        if (interaction.options.getSubcommand() === "setup") {
            ...
            if (!checkChan(ticketChannel as Channel, ChannelType.GuildText) || !checkChan(ticketLogChannel as Channel, ChannelType.GuildText) || !checkChan(ticketClosedCategory as Channel, ChannelType.GuildCategory)) {
