...
const statsModel = require('../../events/models/serverStats.js');
...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (statsDoc) {
            await message.reply({ content: 'Server stats has already been setup! Do you want to update and reconfigure? (Yes/No)' }).then(async (sentMessage) => {
